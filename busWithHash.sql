...
select * from tbl_users order by u_id
 

INSERT INTO tbl_users VALUES
('user_001', 'Aarav', 'Singh', 'aarav.singh@gmail.com', HASHBYTES('MD2','password1')),
('user_002', 'Aarohi', 'Sharma', 'aarohi.sharma@yahoo.com', HASHBYTES('MD2','password2')),
('user_003', 'Abhishek', 'Gupta', 'abhishek.gupta@gmail.com', HASHBYTES('MD2','password3')),
('user_004', 'Aditi', 'Chopra', 'aditi.chopra@yahoo.com', HASHBYTES('MD2','password4')),
('user_005', 'Advait', 'Joshi', 'advait.joshi@gmail.com', HASHBYTES('MD2','password5')),
('user_006', 'Ahana', 'Malhotra', 'ahana.malhotra@yahoo.com', HASHBYTES('MD2','password6')),
('user_007', 'Akhil', 'Nair', 'akhil.nair@gmail.com', HASHBYTES('MD2','password7')),
('user_008', 'Akshara', 'Menon', 'akshara.menon@yahoo.com', HASHBYTES('MD2','password8')),
('user_009', 'Akshay', 'Kumar', 'akshay.kumar@gmail.com', HASHBYTES('MD2','password9')),
('user_010', 'Alok', 'Verma', 'alok.verma@yahoo.com', HASHBYTES('MD2','password10')),
('user_011', 'Amit', 'Sharma', 'amit.sharma@gmail.com', HASHBYTES('MD2','password11')),
('user_012', 'Amrita', 'Nair', 'amrita.nair@yahoo.com', HASHBYTES('MD2','password12')),
('user_013', 'Anand', 'Pillai', 'anand.pillai@gmail.com', HASHBYTES('MD2','password13')),
('user_014', 'Ananya', 'Saxena', 'ananya.saxena@yahoo.com', HASHBYTES('MD2','password14')),
('user_015', 'Aniket', 'Jain', 'aniket.jain@gmail.com', HASHBYTES('MD2','password15')),
('user_016', 'Anil', 'Kapoor', 'anil.kapoor@yahoo.com', HASHBYTES('MD2','password16')),
('user_017', 'Anish', 'Mathew', 'anish.mathew@gmail.com', HASHBYTES('MD2','password17')),
('user_018', 'Anjali', 'Shah', 'anjali.shah@yahoo.com', HASHBYTES('MD2','password18')),
('user_019', 'Anjana', 'Menon', 'anjana.menon@gmail.com', HASHBYTES('MD2','password19')),
('user_020', 'Ankit', 'Gupta', 'ankit.gupta@yahoo.com', HASHBYTES('MD2','password20')),
('user_021', 'Ansh', 'Singh', 'ansh.singh@gmail.com', HASHBYTES('MD2','password21')),
('user_022', 'Aparna', 'Kumar', 'aparna.kumar@yahoo.com', HASHBYTES('MD2','password22')),
('user_023', 'Apoorva', 'Sharma', 'apoorva.sharma@gmail.com', HASHBYTES('MD2','password23')),
('user_024', 'Aravind', 'Nair', 'aravind.nair@yahoo.com', HASHBYTES('MD2','password24')),
('user_025', 'Arjun', 'Pillai', 'arjun.pillai@gmail.com', HASHBYTES('MD2','password25')),
('user_026', 'Arnav', 'Saxena', 'arnav.saxena@yahoo.com', HASHBYTES('MD2','password26')),
('user_027', 'Aryan', 'Chopra', 'aryan.chopra@gmail.com', HASHBYTES('MD2','password27')),
('user_028', 'Ashok', 'Menon', 'ashok.menon@yahoo.com', HASHBYTES('MD2','password28')),
('user_029', 'Ashwani', 'Kapoor', 'ashwani.kapoor@gmail.com', HASHBYTES('MD2','password29')),
('user_030', 'Avi', 'Sharma', 'avi.sharma@yahoo.com', HASHBYTES('MD2','password30')),
('user_031', 'Avinash', 'Singh', 'avinash.singh@gmail.com', HASHBYTES('MD2','password31')),
('user_032', 'Bhavana', 'Nair', 'bhavana.nair@yahoo.com', HASHBYTES('MD2','password32')),
('user_033', 'Bhavesh', 'Joshi', 'bhavesh.joshi@gmail.com', HASHBYTES('MD2','password33')),
('user_034', 'Bhuvan', 'Verma', 'bhuvan.verma@yahoo.com', HASHBYTES('MD2','password34')),
('user_035', 'Chirag', 'Shah', 'chirag.shah@gmail.com', HASHBYTES('MD2','password35')),
('user_036', 'Dhruv', 'Menon', 'dhruv.menon@yahoo.com', HASHBYTES('MD2','password36')),
('user_037', 'Divya', 'Kapoor', 'divya.kapoor@gmail.com', HASHBYTES('MD2','password37')),
('user_038', 'Gaurav', 'Singh', 'gaurav.singh@yahoo.com', HASHBYTES('MD2','password38')),
('user_039', 'Geeta', 'Nair', 'geeta.nair@gmail.com', HASHBYTES('MD2','password39')),
('user_040', 'Girish', 'Jain', 'girish.jain@yahoo.com', HASHBYTES('MD2','password40')),
('user_041', 'Hari', 'Sharma', 'hari.sharma@gmail.com', HASHBYTES('MD2','password41')),
('user_042', 'Harish', 'Pillai', 'harish.pillai@yahoo.com', HASHBYTES('MD2','password42')),
('user_043', 'Isha', 'Menon', 'isha.menon@gmail.com', HASHBYTES('MD2','password43')),
('user_044', 'Jaya', 'Kumar', 'jaya.kumar@yahoo.com', HASHBYTES('MD2','password44')),
('user_045', 'Jitendra', 'Singh', 'jitendra.singh@gmail.com', HASHBYTES('MD2','password45')),
('user_046', 'Kabir', 'Verma', 'kabir.verma@yahoo.com', HASHBYTES('MD2','password46')),
('user_047', 'Kalyani', 'Nair', 'kalyani.nair@gmail.com', HASHBYTES('MD2','password47')),
('user_048', 'Kapil', 'Shah', 'kapil.shah@yahoo.com', HASHBYTES('MD2','password48')),
('user_049', 'Kartik', 'Jain', 'kartik.jain@gmail.com', HASHBYTES('MD2','password49')),
('user_050', 'Kavita', 'Kapoor', 'kavita.kapoor@yahoo.com', HASHBYTES('MD2','password50')),
('user_051', 'Krishna', 'Singh', 'krishna.singh@gmail.com', HASHBYTES('MD2','password51')),
('user_052', 'Kritika', 'Sharma', 'kritika.sharma@yahoo.com', HASHBYTES('MD2','password52')),
('user_053', 'Kunal', 'Pillai', 'kunal.pillai@gmail.com', HASHBYTES('MD2','password53')),
('user_054', 'Lakshmi', 'Nair', 'lakshmi.nair@yahoo.com', HASHBYTES('MD2','password54')),
('user_055', 'Mahesh', 'Kumar', 'mahesh.kumar@gmail.com', HASHBYTES('MD2','password55')),
('user_056', 'Manish', 'Singh', 'manish.singh@yahoo.com', HASHBYTES('MD2','password56')),
('user_057', 'Mayank', 'Shah', 'mayank.shah@gmail.com', HASHBYTES('MD2','password57')),
('user_058', 'Mohan', 'Jain', 'mohan.jain@yahoo.com', HASHBYTES('MD2','password58')),
('user_059', 'Nandini', 'Menon', 'nandini.menon@gmail.com', HASHBYTES('MD2','password59')),
('user_060', 'Neha', 'Kapoor', 'neha.kapoor@yahoo.com', HASHBYTES('MD2','password60')),
('user_061', 'Nikhil', 'Sharma', 'nikhil.sharma@gmail.com', HASHBYTES('MD2','password61')),
('user_062', 'Nitin', 'Pillai', 'nitin.pillai@yahoo.com', HASHBYTES('MD2','password62')),
('user_063', 'Pooja', 'Verma', 'pooja.verma@gmail.com', HASHBYTES('MD2','password63')),
('user_064', 'Prachi', 'Nair', 'prachi.nair@yahoo.com', HASHBYTES('MD2','password64')),
('user_065', 'Pradeep', 'Kumar', 'pradeep.kumar@gmail.com', HASHBYTES('MD2','password65')),
('user_066', 'Pranav', 'Singh', 'pranav.singh@yahoo.com', HASHBYTES('MD2','password66')),
('user_067', 'Prasad', 'Shah', 'prasad.shah@gmail.com', HASHBYTES('MD2','password67')),
('user_068', 'Prashant', 'Jain', 'prashant.jain@yahoo.com', HASHBYTES('MD2','password68')),
('user_069', 'Priya', 'Menon', 'priya.menon@gmail.com', HASHBYTES('MD2','password69')),
('user_070', 'Rahul', 'Kapoor', 'rahul.kapoor@yahoo.com', HASHBYTES('MD2','password70')),
('user_071', 'Raj', 'Singh', 'raj.singh@gmail.com', HASHBYTES('MD2','password71')),
('user_072', 'Rajeev', 'Nair', 'rajeev.nair@yahoo.com', HASHBYTES('MD2','password72')),
('user_073', 'Rakesh', 'Shah', 'rakesh.shah@gmail.com', HASHBYTES('MD2','password73')),
('user_074', 'Ranbir', 'Verma', 'ranbir.verma@yahoo.com', HASHBYTES('MD2','password74')),
('user_075', 'Ravi', 'Pillai', 'ravi.pillai@gmail.com', HASHBYTES('MD2','password75')),
('user_076', 'Riya', 'Nair', 'riya.nair@yahoo.com', HASHBYTES('MD2','password76')),
('user_077', 'Ronak', 'Kumar', 'ronak.kumar@gmail.com', HASHBYTES('MD2','password77')),
('user_078', 'Sagar', 'Singh', 'sagar.singh@yahoo.com', HASHBYTES('MD2','password78')),
('user_079', 'Sameer', 'Sharma', 'sameer.sharma@gmail.com', HASHBYTES('MD2','password79')),
('user_080', 'Sanjay', 'Jain', 'sanjay.jain@yahoo.com', HASHBYTES('MD2','password80'))
...
select booking_id,sum(number_of_seats) from tbl_booking group by bus_id,booking_id having booking_id=9
...
--Triggers
--AUDIT TABLE
drop table tbl_customerTriggerAudit

CREATE TABLE tbl_customerTriggerAudit
(id INT IDENTITY(1,1), audit_text VARCHAR(50) )

select * from tbl_customerTriggerAudit;

--EMAIL TABLE
drop table tbl_emailTrigger
CREATE TABLE tbl_emailTrigger
(id INT IDENTITY(1,1),email varchar(40),email_text VARCHAR(50) )

select * from tbl_emailTrigger

--BUS CONFIRMATION TABLE
CREATE TABLE tbl_confirmationTrigger
(id INT IDENTITY(1,1),confirmation_text VARCHAR(100) )

drop table tbl_confirmationTrigger
...
INSERT INTO tbl_customerTriggerAudit 
...
SELECT @id=u_id FROM deleted
INSERT INTO tbl_customerTriggerAudit 
VALUES('user with id ' + @id +  ' deleted ')
END

delete from tbl_users where u_id='user_081'
select * from tbl_users
select * from tbl_customerTriggerAudit;
...
select @busName=bus_name from tbl_buses b JOIN tbl_booking tb on b.bus_id=tb.bus_id
INSERT INTO tbl_confirmationTrigger
VALUES('Your bus name and number is '+@busName+' and '+@busNum+'!')
END


select * from tbl_booking
insert into tbl_booking values (73,'user_061','bus_008',3,(SELECT fare FROM tbl_buses WHERE bus_id = 'bus_008') * 3)
delete from tbl_booking where booking_id=73
select * from tbl_confirmationTrigger


--update Trigger to show changes occuring 
create table tbl_updateTriggeraudit(id int identity,audit text);
select * from tbl_updateTriggeraudit
...
while(exists(select u_id from #temptable))
begin
set @AuditText=' '
select top 1 @user_id=u_id,@newFN=first_name,@newLN=last_name,
@newEmail=email,@newPass=pass from #temptable

select @oldFN=first_name,@oldLN=last_name,@oldEmail=email,@oldPass=pass from deleted where u_id=@user_id
...
insert into tbl_updateTriggeraudit values (@AuditText)
delete from #temptable where u_id=@user_id
end
end
...
--DDL trigger showing change in details
...
insert into busBooking.dbo.tbl_auditTableChanges(databaseName,table_name,
event_type,login_name,sql_command,audit_date_time) values
(
...
@EventData.value('(/EVENT_INSTANCE/TSQLCommand)[1]','varchar(1000)'),
GETDATE()
)
END
...
DECLARE @count INT
EXECUTE usp_user_count @count OUT
PRINT @count

--seat availability for specified bus
create PROC uspAvailableSeats
@busNo varchar(30)
as
begin
select s.bus_id,bus_name,available_seats from tbl_seats s JOIN tbl_buses b 
on s.bus_id=@busNo and s.bus_id=b.bus_id
end

uspAvailableSeats 'bus_003'


--check bus availability on specified dates
create PROC uspBusAvailability
@busNo varchar(30),
@date datetime
as
begin
select bus_id,bus_name from tbl_buses where bus_id=@busNo and departure_time>@date
end

uspBusAvailability 'bus_009','2023-06-21 00:00:00.000'

--sp to get reviews on bus mentioned
create PROC uspBusReviews
@busNo varchar(30)
as
begin
select first_name+' '+last_name as username,bus_name as busname,rating,review_text 
--from tbl_users u,tbl_buses b,tbl_reviews r
--where r.bus_id=@busNo and u.u_id=r.u_id and b.bus_id=r.bus_id

from tbl_users u JOIN tbl_reviews r ON r.bus_id=@busNo and u.u_id=r.u_id JOIN tbl_buses b ON b.bus_id=r.bus_id
end

uspBusReviews 'bus_005'

--sp to get reviews based on rating
create PROC uspBusReviewsOnRating
@busNo varchar(30),
@rating int
as
begin
select first_name+' '+last_name as username,bus_name as busname,rating,review_text 
from tbl_users u JOIN tbl_reviews r ON r.bus_id=@busNo and u.u_id=r.u_id JOIN tbl_buses b ON b.bus_id=r.bus_id and rating=@rating
end

uspBusReviewsOnRating 'bus_005',5
...
uspBusSeatBooking 'user_075','bus_003',3
drop procedure uspBusSeatBooking


--Table Type to insert user details
create type ut_conductor_details as table
(
...
create procedure usp_insert_conductor_details(@conductorDetails [ut_conductor_details] ReadOnly)
as
begin
insert into dbo.tbl_conductor
(
conductor_id,conductor_name,bus_id
)
end

declare @Detail as [ut_conductor_details];
insert into @Detail
select '16','Gautham Ghetia','bus_009' union all
select '17','Mohammed Hanin','bus_010'
exec dbo.usp_insert_conductor_details @Detail

select * from tbl_conductor

delete from tbl_conductor where conductor_id in ('16','17')



--stored procedure to provide reply to reviews based on bus_id and stars
create PROCEDURE sp_create_temp_table_with_reply_based_on_stars(
    @bus_id VARCHAR(10)
)
AS
BEGIN
    ...
    CREATE TABLE #temp_reviews (
        ...
        rating TINYINT NOT NULL,
        review_text VARCHAR(MAX) NOT NULL,
        reply_text VARCHAR(MAX) NULL -- New column for reply text
    );

    -- Insert data from tbl_reviews into the temporary table
    INSERT INTO #temp_reviews
    SELECT review_id, u_id, bus_id, rating, review_text,
        CASE
            WHEN rating > 3 THEN 'Thank you'
            ELSE 'We apologize'
        END AS reply_text
    FROM tbl_reviews
    WHERE bus_id = @bus_id;
...
EXEC sp_create_temp_table_with_reply_based_on_stars 'bus_001'
...
--stored procedure to check seats and then booking the seats
select * from tbl_users
select * from tbl_buses
select * from tbl_booking
...
create PROCEDURE uspBusSeatBooking
@userid varchar(20),
@busid varchar(20),
@bookedSeats Int
AS 
...
ELSE
BEGIN
EXEC uspBusSeatBooking  @userid, @busid, 5

DECLARE @remaining_seats INT = @bookedSeats - 5  ;
EXEC uspBusSeatBooking @userid, @busid, @remaining_seats
...
uspBusSeatBooking 'user_075','bus_014',7
...
UPDATE TBL_DRIVER SET EXPERIENCE=4 WHERE DRIVER_ID=15

select * from tbl_conductor

--View displaying details of users
create view vw_user_details
as
select u.u_id,first_name+' '+last_name as full_name,b.bus_id,number_of_seats from 
tbl_users u join tbl_booking b on u.u_id=b.u_id

select * from vw_user_details


--View displaying details of users along with bus name
create view vw_user_details_with_bus
as
select u.u_id,first_name+' '+last_name as full_name,b.bus_id,bus_name,number_of_seats from 
tbl_users u join tbl_booking b on u.u_id=b.u_id join tbl_buses bus on bus.bus_id=b.bus_id

select * from vw_user_details_with_bus

--View for displaying reviews 
CREATE view vw_reviews_with_details
as
select first_name+' '+last_name as full_name,bus_name,rating,review_text from
tbl_users u join tbl_reviews r on r.u_id=u.u_id join tbl_buses b on r.bus_id=b.bus_id

select * from vw_reviews_with_details

-- View for driver details
CREATE view vw_driver_details
as
select driver_id,driver_name,b.bus_id,bus_name,starting_point,destination
from tbl_driver d join tbl_buses b 
on d.bus_id=b.bus_id

select * from vw_driver_details

select d.*,conductor_id,conductor_name from vw_driver_details d join tbl_conductor c 
...
create FUNCTION fn_seat_availability(@bus_name VARCHAR(25))
RETURNS INT
AS
BEGIN
RETURN (SELECT available_seats FROM tbl_seats s join tbl_buses b on s.bus_id=b.bus_id and bus_name=@bus_name )
END

SELECT dbo.fn_seat_availability('Express') as seat_availability

--function to get bus reviews
create FUNCTION fn_bus_reviews(@bus_name VARCHAR(25))
RETURNS TABLE
AS
RETURN (SELECT bus_name,review_text FROM tbl_reviews r join tbl_buses b on r.bus_id=b.bus_id and bus_name=@bus_name )


SELECT * from fn_bus_reviews('Express')

--function to check seats are available or no
create function fn_seat_availability_with_number_of_seats(@bus_id VARCHAR(10),@seats int)
returns varchar(20)
as
begin
return (SELECT
  CASE
    WHEN @seats < available_seats THEN 'Available'
    ELSE 'Unavailable'
  END AS Seat_Availability
FROM tbl_seats where bus_id=@bus_id)
end

SELECT dbo.fn_seat_availability_with_number_of_seats('bus_001',30) as seat_availability

alter function fn_seat_availability_with_number_of_seats(@bus_name VARCHAR(25),@seats int)
returns varchar(20)
as
begin
return (SELECT
  CASE
    ...
    ELSE 'Unavailable'
  END AS Seat_Availability
FROM tbl_seats s join tbl_buses b on s.bus_id=b.bus_id and bus_name=@bus_name)
end

SELECT dbo.fn_seat_availability_with_number_of_seats('Express',24) as seat_availability


--function to get bus details on driver name
create function fn_bus_details_on_driver_name(@name VARCHAR(30))
RETURNS TABLE
AS
RETURN (
SELECT driver_id,driver_name,bus_id FROM tbl_driver where driver_name=@name
)

SELECT * from fn_bus_details_on_driver_name('Rajesh Kumar')


--fucntion to get bus and conductor details from driver name
CREATE function fn_bus_and_conductor_details_on_driver_name(@name VARCHAR(30))
RETURNS TABLE
AS
RETURN (
SELECT driver_name,conductor_name,bus_name,total_seats,available_seats 
FROM tbl_driver d join tbl_buses b on d.bus_id=b.bus_id
and driver_name=@name join tbl_conductor c on c.bus_id=b.bus_id 
join tbl_seats s on s.bus_id=b.bus_id 
)

SELECT * from fn_bus_and_conductor_details_on_driver_name('Rajesh Kumar') 


--function to get avg rating of bus 
CREATE FUNCTION fn_avg_rating(@bus_name VARCHAR(25))
RETURNS TABLE
AS
RETURN (SELECT bus_name,avg(rating) as avg_rating FROM tbl_reviews r
join tbl_buses b on r.bus_id=b.bus_id 
and bus_name=@bus_name
group by bus_name)

SELECT * from fn_avg_rating('Express')


--funtion to validate password
ALTER FUNCTION fn_validate_pass
(
@Username VARCHAR(30),
@Password VARCHAR(30)
)
...
SELECT @loginstatus =
					(CASE WHEN PASS = HASHBYTES('MD2',@Password)THEN 'CORRECT PASSWORD'
...
SELECT dbo.fn_validate_pass ('Aarav Singh', 'password1')
...
--CTE to get total fare of all buses
WITH cte_total_fare
AS
(
SELECT sum(total_fare) as total from tbl_booking
)
select total from cte_total_fare


--CTE to get total fare of each buses
WITH cte_total_fare_for_each_bus
AS
(
--SELECT bus_id,sum(total_fare) from tbl_booking group by bus_id

select bus_name,book.bus_id,sum(total_fare) as total from tbl_booking book join tbl_buses bus 
on book.bus_id=bus.bus_id group by bus_name,book.bus_id
)
select bus_name,total from cte_total_fare_for_each_bus



--CTE to show user booking details
WITH cte_user_booking_details
AS
(
select u_id,first_name+' '+last_name as full_name from tbl_users
)
select d.u_id,full_name,b.bus_id,bus_name,number_of_seats,total_fare 
from cte_user_booking_details d join tbl_booking b
on d.u_id=b.u_id join tbl_buses bus on b.bus_id=bus.bus_id


--CTE to show driver and conductor details for all buses
WITH cte_driver_and_conductor_for_buses
AS
(
select d.bus_id,driver_name,conductor_name from tbl_driver d join tbl_conductor c on d.bus_id=c.bus_id
)
select bus_name,driver_name,conductor_name from cte_driver_and_conductor_for_buses cte
join tbl_buses bus on bus.bus_id=cte.bus_id


WITH cte_driver_and_conductor_for_buses1
AS
(
select d.bus_id,driver_name,conductor_name from tbl_driver d join tbl_conductor c on d.bus_id=c.bus_id
),
cte_driver_and_conductor_for_buses2
AS
(
select bus_id,bus_name from tbl_buses
)
select bus_name,driver_name,conductor_name from cte_driver_and_conductor_for_buses1 cte1 join 
cte_driver_and_conductor_for_buses2 cte2 on cte1.bus_id=cte2.bus_id


--CTE to show min and max rating
WITH cte_min_max_ratings AS (
SELECT bus_name,MIN(rating) AS min_rating,MAX(rating) AS max_rating
FROM tbl_reviews r join tbl_buses b on r.bus_id=b.bus_id
GROUP BY bus_name
)
--select * from cte_min_max_ratings 

--multi-level aggregations is possible in CTE [  avg(min(rating))   ]
SELECT AVG(min_rating) AS avg_min_rating,AVG(max_rating) AS avg_max_rating
FROM cte_min_max_ratings;


--CTE to show avg spending of the user
WITH cte_avg_spendings AS (
SELECT u_id,min(total_fare) as min_spendings,max(total_fare) as max_spendings,avg(total_fare) AS avg_spendings from tbl_booking
GROUP BY u_id
)
--select * from cte_avg_spendings

SELECT AVG(avg_spendings) AS total_avg_spending
FROM cte_avg_spendings;

--CTE to update user password
WITH cte_ChangeCustomerLoginPassword as
(select * from tbl_users where first_name+' '+last_name = 'Aarav Singh')


update cte_ChangeCustomerLoginPassword
set pass = HASHBYTES('MD2','password1')



--Recursive CTE for showing heirarchy in tbl_drivers based on experience
select * from tbl_driver

WITH cte_experience_hierarchy AS (
  SELECT driver_id, driver_name, bus_id, experience, 1 AS [level]
  FROM tbl_driver
  WHERE experience in (select max(experience) from tbl_driver) 

  UNION ALL

  SELECT t.driver_id, t.driver_name, t.bus_id, t.experience, eh.[level] + 1
  FROM tbl_driver t
  JOIN cte_experience_hierarchy eh ON t.experience = eh.experience - 1
)
SELECT distinct driver_id, driver_name, bus_id, experience, [level]
FROM cte_experience_hierarchy
ORDER BY [level];


select *,dense_rank() over(order by experience desc) rank from tbl_driver
